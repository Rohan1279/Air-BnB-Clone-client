  ...
  return (
    <header className="text-gray-900 body-font shadow-sm">
      <div className=" mx-auto flex flex-wrap py-5 px-20 flex-col md:flex-row items-center">
        <Link
          to="/"
          className="flex title-font font-medium items-center text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-rose-400 mb-4 md:mb-0"
        >
          <span className="ml-3 text-2xl font-bold ">Air BnB Clone</span>
        </Link>
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          {user?.email ? (
            ...
            <>
              <Link to="/login" className="mr-5 hover:text-rose-600">
                Login
              </Link>
