        ...
        <div className='w-full max-w-md p-8 space-y-3 text-gray-800 rounded-xl bg-gray-50'>
          <form className='space-y-6 ng-untouched ng-pristine ng-valid'>
            <div className='space-y-1 text-sm'>
              ...
              <input
                className='w-full px-4 py-3 text-gray-800 border border-rose-300 focus:outline-rose-500 rounded-md bg-rose-50'
                name='location'
                id='location'
                type='text'
            ...
            <div className='flex space-x-4 items-center'>
              <label
                htmlFor='image'
                className='p-3 text-center rounded-md cursor-pointer text-gray-500 font-bold border  border-rose-600 hover:bg-gradient-to-r hover:from-blue-500 hover:to-rose-400 hover:border-white hover:text-white'
              >
                <input
                  type='file'
                  name='image'
            ...
            <div className='space-y-1 text-sm'>
              ...
              <textarea
                id='description'
                className='block rounded-md focus:rose-300 w-full h-20 px-4 py-3 text-gray-800 bg-rose-50 border border-rose-300 focus:outline-rose-500 '
                name='description'
              ></textarea>
            </div>
